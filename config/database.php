...
return [
    ...
    */
    ...
    'default' => env('MYSQLDATABASE') ? 'mysql' : env('DB_CONNECTION', 'sqlite'),
    ...
    */
    ...
    'connections' => [
        ...
        'sqlite' => [
            'driver' => 'sqlite',
            'url' => env('DB_URL'),
            'database' => env('DB_DATABASE', isset($_ENV['RAILWAY_ENVIRONMENT']) ? storage_path('database.sqlite') : database_path('database.sqlite')),
            'prefix' => '',
