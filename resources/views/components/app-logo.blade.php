...
@if($sidebar)
    <a {{ $attributes->merge(['class' => 'flex items-center gap-4 px-2 py-2']) }}>
        <div class="flex aspect-square size-12 items-center justify-center rounded-full bg-white/10/10 p-0.5 shadow-[0_0_18px_rgba(255,255,255,0.12)] border border-white/20 shrink-0">
