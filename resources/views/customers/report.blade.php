    ...
    <div class="max-w-5xl mx-auto bg-white/10 p-10 shadow-lg rounded-lg print-container">
        ...
        <div class="flex justify-between items-start border-b-2 border-white/20 pb-8 mb-8">
            ...
            <div class="no-print flex gap-4">
                <a href="javascript:history.back()" class="bg-[#1b2636] hover:bg-[#263548] text-gray-300 border border-[#2d4059] px-6 py-3 rounded-xl font-bold shadow-lg transition-all flex items-center gap-2">
