<x-layouts::app title="Register New Customer">
    <div class="px-6 py-4 bg-transparent min-h-screen font-sans text-gray-300">
        ...
        <div class="bg-[#121a25]/80 backdrop-blur-md rounded shadow-sm overflow-hidden border border-[#263548] max-w-3xl">
            <form method="POST" action="{{ route('customers.store') }}" class="p-6">
                @csrf
                
                <h3 class="text-[#337ab7] font-semibold text-base mb-6 border-b border-[#263548] pb-2">Customer Details</h3>
                ...
                <div class="mb-8">
                    <label class="block text-gray-400 mb-1 text-sm font-medium">Barangay <span class="text-red-500">*</span></label>
                    <div class="flex flex-col md:flex-row gap-4 items-start">
                        <div class="w-full md:w-1/2 text-gray-200 bg-[#0f151e]">
                            <input type="text" name="barangay" id="barangay" list="barangays_list" value="{{ old('barangay') }}" required placeholder="e.g. BRGY 1"
                        ...
                        <div class="w-full md:w-1/2 bg-[#1a2432]/30 p-2 border border-[#263548] rounded min-h-[42px] flex items-center">
                    ...
                    <p class="text-[10px] text-gray-500 mt-2 font-bold uppercase tracking-widest italic">Dolores Eastern Samar will be automatically added to the address.</p>
                </div>
