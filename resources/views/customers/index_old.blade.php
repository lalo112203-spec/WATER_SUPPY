<x-layouts::app title="Customers">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-emerald-500/10 p-4 rounded-2xl border border-emerald-500/30 flex justify-between items-center px-6">
                        ...
                        <div class="text-right">
                            <span class="text-emerald-400 font-bold text-3xl">Γé▒<span id="modal_total_display">0.00</span></span>
                        </div>
                    </div>
    ...
    <script>
        ...
        function calculateQuickCharges() {
            ...
            breakdown.textContent = `Consumption: ${consumption.toFixed(2)}L | (${consumption.toFixed(2)} - 10) ├ù Γé▒${rate} = Γé▒${usageCharge.toFixed(2)}`;
