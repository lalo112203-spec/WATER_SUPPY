...
$classes = Flux::classes()
    ...
    ->add('bg-white/10/10 dark:bg-white/10/10 dark:hover:bg-white/10/15 dark:data-checked:bg-white/10/15')
    ...
    ->add(match ($accent) {
        true => [
            ...
            'data-checked:border-(--color-accent) hover:data-checked:border-(--color-accent) dark:data-checked:bg-white/10/15 ',
            'hover:after:bg-[var(--haze-light)] dark:hover:after:bg-white/10/[4%] data-checked:after:bg-(--haze) hover:data-checked:after:bg-(--haze)',
        ],
        false => [
            'data-checked:bg-zinc-50 dark:data-checked:bg-white/10/15 data-checked:border-zinc-800 dark:data-checked:border-white',
            'hover:bg-zinc-50 dark:hover:bg-white/10/15',
        ],
    })
