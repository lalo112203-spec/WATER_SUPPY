...
$classes = Flux::classes()
    ...
    ->add('bg-zinc-800/6 dark:bg-white/10/10 hover:bg-zinc-800/10 dark:hover:bg-white/10/15 text-zinc-800 hover:text-zinc-800 dark:text-white/70 dark:hover:text-white')
    ->add(match ($accent) {
        true => 'data-checked:bg-(--color-accent) hover:data-checked:bg-(--color-accent)',
        false => 'data-checked:bg-zinc-800 dark:data-checked:bg-white/10',
    })
    ->add(match ($accent) {
