...
$classes = Flux::classes()
    ...
    ->add(match ($variant) { // Background color...
        ...
        'filled' => 'bg-zinc-800/5 hover:bg-zinc-800/10 dark:bg-white/10/10 dark:hover:bg-white/10/20',
        'outline' => 'bg-white/10/10 hover:bg-zinc-50 dark:bg-zinc-700 dark:hover:bg-zinc-600/75',
        'danger' => 'bg-red-500 hover:bg-red-600 dark:bg-red-600 dark:hover:bg-red-500',
        'ghost' => 'bg-transparent hover:bg-zinc-800/5 dark:hover:bg-white/10/15',
        'subtle' => 'bg-transparent hover:bg-zinc-800/5 dark:hover:bg-white/10/15',
    })
